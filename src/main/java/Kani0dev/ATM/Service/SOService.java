...
public class SOService {
    ...
    public List<ServiceOrder> gettAllSOFromDevice(long device_id,ServiceOrder serviceOrder){
    ...
    public void rmServiceFromDevice(long device_id,ServiceOrder serviceOrder){
